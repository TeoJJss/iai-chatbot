...
async def get_qa(inp, ori_inp):
    ...
    if [i for i in ["resit", "retak", "referral", "result","remark"] if i in str(ori_inp).lower()]:
        ...
        add_qa = {
            "Resit will be scheduled within 6-8 weeks after result release. You will be auto-registered for failed modules. \nPlease check your APSpace Result page":[
                ...
                "how to check when is resit",
                "how to check when is retake",
                "how to check when is referral",
                "how to see resit",
                "how to see retake",
                "how to see referral",
                "how to see when is resit",
                "how to see when is retake",
                "how to see when is referral"
            ],
    ...
    if [i for i in ["fee", "pay", "paid", "bank", "maybank", "cimb", "flywire", "jompay", "cheque"] if i in str(inp).lower() or i in str(ori_inp).lower()]:
        ...
        add_qa = {
            ...
            \n*Remember to email the payment receipt with student name and ID to __bursary@apu.edu.my__*": [
                ...
                "how can I make payment by CIMB",
                "how can I make payment via CIMB",
                "how should I make payment using CIMB",
            ...
            "**Cheque or Banker's Draft Payment**\
                ...
                \n*You may handover the document to the bursary counter at Level 3 Spine, APU Campus*":[
                    ...
                    "How to pay with banker's draft",
                    "How to pay using cheque",
                    "How to pay using banker's draft",
                    "How to pay through cheque",
                    ...
                    "How to pay with cheque",
                    "How to pay fees using cheque",
                    "How to use cheque to make payment",
                    "Procedure to make payment with cheque",
                    "Instructions to make payment with cheque",
                    "How does payment work on cheque?",
                    "How do I make a transfer with cheque?",
                    "Steps to pay with cheque",
                    "How can I make payment using cheque",
                    "Guide me how to use cheque to make payment",
                    "Explain how to use cheque for payments",
                    "What are the instructions for cheque payments",
                    "pay cheque", 
                    "How to  through cheque",
                    "How do I make a transaction using cheque",
                    "Steps to  through cheque",
                    "How do I use cheque?",
                    "How to send money through cheque?",
                    "how should I make payment using cheque",
                    "how should I make payment via cheque",
                    "how should I make payment by cheque",
                    "how should I make payment through cheque",
                    "how should I make payment with cheque",
                    "how can I make payment using cheque",
                    "how can I make payment via cheque",
                    ...
                    "cheque account details",
                    "banker's draft account details",
            ],
            ...
            \n5) Follow the steps to transfer funds to Flywire.\n6) Get updates via text and email until your payment reaches your institution. You can also track it anytime by creating a Flywire account.": [
                ...
                "How to use Flywire to make payment",
                "pay flywire", 
                "How to  through Flywire",
                "How do I make a transaction using Flywire",
                "Steps to  through Flywire",
                ...
                "how should I make payment by Flywire",
                "how should I make payment through Flywire",
                "how should I make payment with Flywire",
                "how can I make payment using Flywire",
            ...
            \n*Remember to email the payment receipt with student name and ID to __bursary@apu.edu.my__*": [
                ...
                "how to pay with jompay",
                "how to pay using Maybank",
                "how to pay using jompay",
                "how to pay through Maybank",
                "how to pay through jompay",
                ...
                "payment Maybank",
                "How to pay fees using Maybank",
                "How to use Maybank to make payment?",
                "Procedure to make payment with Maybank",
                "Instructions to make payment with Maybank",
                "How does payment work on Maybank?",
                "How do I make a transfer with Maybank?",
                "Steps to pay with Maybank",
                "How can I make payment using Maybank",
                "Guide me how to use Maybank to make payment",
                "Explain how to use Maybank for payments",
                "What are the instructions for Maybank payments",
                "How to use Maybank to make payment",
                "How to  through Maybank",
                "How do I make a transaction using Maybank",
                "Steps to  through Maybank",
                "How do I use Maybank?",
                "How to send money through Maybank?",
                "How do I make a transfer with JomPay?",
                ...
                "How to pay through JomPay",
                "How to pay using JomPay",
                "How to pay fees using JomPay",
                "How to use JomPay to make payment?",
                "Procedure to make payment with JomPay",
                "Instructions to make payment with JomPay",
                "How does payment work on JomPay?",
                "Steps to pay with JomPay",
                "How can I make payment using JomPay",
                "Guide me how to use JomPay to make payment",
                "Explain how to use JomPay for payments",
                "What are the instructions for JomPay payments",
                "How to use JomPay to make payment",
                "pay JomPay", 
                "How to  through JomPay",
                "How do I make a transaction using JomPay",
                "Steps to  through JomPay",
                "How do I use JomPay?",
                "pay with JomPay",
                "How to send money through JomPay?",
                "how should I make payment using maybank",
                "how should I make payment using jompay",
                "how should I make payment via maybank",
                "how should I make payment via jompay",
                "how should I make payment by maybank",
                "how should I make payment by jompay",
                "how should I make payment through maybank",
                "how should I make payment through jompay",
                "how should I make payment with maybank",
                "how should I make payment with jompay",

                "how can I make payment using maybank",
                "how can I make payment using jompay",
                "how can I make payment via maybank",
                "how can I make payment via jompay",
                "how can I make payment by maybank",
                "how can I make payment by jompay",
    ...
    if [i for i in ["operat", "hour", "time", "open", "close"] if i in str(inp).lower()]:
        ...
        add_qa = {
            ...
            "**Operational Hours of APU Campus Connect Lounge:**\n Monday – Friday: 8.00am – 10.00pm":[
                ...
                "What is the operating hours of APU Campus Connect Lounge",
                "What is the operation hours of APU Campus Connect Lounge",
            ],
            ...
            \n\n**Operating hour of APIIT library**\nMonday – Friday: 8:30 a.m. – 6:00 p.m.,\nSaturday / Sunday / Public Holidays: Closed ": [
                ...
                "What is the operation hours of library",
                "Operating hour of APU library",
                "Operating hour of APIIT library",
            ...
            "**Operating hour of Admin Office @ APU**\nMonday – Friday: 8:30 a.m. – 6:00 p.m.\nSaturday / Sunday / Public Holidays: Closed": [
                ...
                "What is the operation hours of admin",
            ...
            "**Operating hour of Bursary Office @ APU**\nMonday – Friday: 9:15 a.m. – 6:00 p.m.\nSaturday / Sunday / Public Holidays: Closed": [
                "What is the operating hours of bursary",
                "What is the operaton hours of bursary",
                "Operating hour of APU bursary",
                "Operation hour of bursary",
                "Operation hour of APU bursary",
                "When does the bursary open?",
                "When does the APU bursary open?",
                "What time does the bursary open",
                "What time does the APU bursary open",
                "What time does the bursary open on weekdays?",
                "What time does the APU bursary open on weekdays?",
                "Is the bursary open on weekends?",
                "Is the APU bursary open on weekends?",
                "Is the bursary open on Saturdays?",
                "Can I visit the bursary on public holidays?",
                "Is the bursary closed on public holidays?",
                "What is the schedule for the bursary",
                "Bursary open hours",
                "APU bursary open hours",
                "Bursary open time",
                "APU bursary open time",
                "APIIT bursary open time",
                "When does the bursary open and close?",
                "When does the APU bursary open and close?",
                "When can I visit the bursary during the week?",
                "bursary operating hour",
                "cashier operating hour",
                "operating hour of bursary",
                "operating hour of cashier",
                "What is the operating hours of cashier",
                "What is the operaton hours of cashier",
                "Operating hour of APU cashier",
                "Operation hour of cashier",
                "Operation hour of APU cashier",
                "When does the cashier open?",
                "When does the APU cashier open?",
                "What time does the cashier open",
                "What time does the APU cashier open",
                "What time does the cashier open on weekdays?",
                "What time does the APU cashier open on weekdays?",
                "Is the cashier open on weekends?",
                "Is the APU cashier open on weekends?",
                "Is the cashier open on Saturdays?",
                "Can I visit the cashier on public holidays?",
                "Is the cashier closed on public holidays?",
                "What is the schedule for the cashier?",
                "cashier open hours",
                "APU cashier open hours",
                "cashier open time",
                "APU cashier open time",
                "APIIT cashier open time",
                "When does the cashier open and close?",
                "When does the APU cashier open and close?",
                "When can I visit the cashier during the week?",
            ],

            # Clinic
            "**Operating hour of Klinik Oceania @ APU**\nMonday – Friday: 9 a.m. – 5 p.m.\nSaturday / Sunday / Public Holidays: Closed": [
                "What is the operating hours of clinic",
                "What is the operation hours of clinic",
            ...
            "**Operating hour of Student Service @ APU**\nMonday – Friday: 8:30 a.m. – 7:00 p.m.\nSaturday: 8:30 a.m. - 1:00 p.m.\nSunday / Public Holidays: Closed": [
                ...
                "What is the operation hours of student service",
            ...
            "**Operating hour of Technology Services @ APU**\nMonday – Friday: 8:30 a.m. – 7:00 p.m.\nSaturday: 9 a.m. - 1 p.m.\nSunday / Public Holidays: Closed": [
                ...
                "What is the operation hours of technology services",
                "What is the operating hours of TA",
                "What is the operation hours of TA",
    ...
    if [i for i in ["shuttle", "bus", "from","to", "trip", "go", "travel"] if i in str(inp).lower()]:
        ...
        if not count:
            try:
                qa["Sorry, the shuttle schedule is unavailable at the moment. \nPlease refer to APSpace or https://www.apu.edu.my/CampusConnect."].extend([
